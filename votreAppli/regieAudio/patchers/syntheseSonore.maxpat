...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 682.0, 77.66832, 30.0, 30.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 422.0, 87.0, 30.0, 30.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 141.744034, 270.143555, 34.0, 22.0 ],
					"style" : "",
					"text" : "sig~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 43.757679, 270.143555, 34.0, 22.0 ],
					"style" : "",
					"text" : "sig~"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 398.535828, 438.559418, 89.0, 17.0 ],
					"preset_data" : [ 						{
							"number" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 398.535828, 415.702972, 100.0, 20.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 58.399319, 77.66832, 24.0, 24.0 ],
					"style" : "buttonGold"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 37.0, 50.0, 72.0, 20.0 ],
					"style" : "",
					"text" : "Play a note"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 558.46759, 270.143555, 65.0, 20.0 ],
					"style" : "",
					"text" : "Amplitude"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 354.610931, 270.143555, 103.0, 20.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 237.477814, 33.0, 57.0, 20.0 ],
					"style" : "",
					"text" : "Duration"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 237.477814, 90.742577, 84.0, 22.0 ],
					"style" : "",
					"text" : "setdomain $1"
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 469.491455, 149.846527, 202.0, 87.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					"addpoints" : [ 0.0, 6.0, 0, 4224.268066, 24.0, 0, 4999.999512, 0.0, 0 ],
					"domain" : 5000.0,
					"id" : "obj-14",
					"maxclass" : "function",
					"numinlets" : 1,
					...
					"outlettype" : [ "float", "", "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 237.477814, 149.846527, 202.0, 87.0 ],
					"range" : [ 0.0, 24.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 143.996582, 200.371292, 75.0, 20.0 ],
					"style" : "",
					"text" : "Harmonicity"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 298.477814, 270.143555, 37.0, 22.0 ],
					"style" : "",
					"text" : "line~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "bang" ],
					"patching_rect" : [ 530.491455, 308.638611, 37.0, 22.0 ],
					"style" : "",
					"text" : "line~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 43.757679, 347.133667, 29.5, 22.0 ],
					"style" : "",
					"text" : "*~"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 141.744034, 229.242569, 62.0, 22.0 ],
					"style" : "numberGold-1",
					"triscale" : 0.9
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 43.757679, 229.242569, 62.0, 22.0 ],
					"style" : "numberGold-1",
					"triscale" : 0.9
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 43.757679, 308.638611, 193.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 46.010239, 200.371292, 80.0, 20.0 ],
					"style" : "",
					"text" : "Carrier Freq."
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 237.477814, 60.668316, 62.0, 22.0 ],
					"style" : "numberGold-1",
					"triscale" : 0.9
				}
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 246.977814, 135.410889, 478.991455, 135.410889 ],
					"order" : 0,
					"source" : [ "obj-12", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 307.977814, 300.819305, 227.257675, 300.819305 ],
					"source" : [ "obj-17", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 539.991455, 340.386139, 63.757679, 340.386139 ],
					"source" : [ "obj-18", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 67.899323, 135.410889, 478.991455, 135.410889 ],
					"order" : 0,
					"source" : [ "obj-7", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 67.899323, 135.410889, 246.977814, 135.410889 ],
					"order" : 1,
					"source" : [ "obj-7", 0 ]
				}
